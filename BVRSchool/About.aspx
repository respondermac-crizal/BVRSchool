<%@ Page Title="About" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.vb" Inherits="BVRSchool.About" %>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row justify-content-center mb-5">
          <div class="col-lg-8 text-center" data-aos="fade-up" data-aos-delay="200">
            <h2 class="section-heading">The Best School in Manvi, Karnataka</h2>
            <p class="lead">It's been a remarkable journey, dedicated to making a qualitative difference in the lives of tens of thousands of children and their aspirational parents. BVR School - The School is the result of B.Venkata reddy's deep introspection and concern over the rampant commercialization and shortcomings of an education system that lacks values and relevance for both the present and the future. Founded in 2001 by BVR Educational Society, BVR School was envisioned to impart quality, value-based education to children, improve ethical standards in education, and embrace a forward-thinking approach that promotes traditional values among the younger generation.</p>
          </div>
        </div>
